                ...
                <div className="col-span-2 text-justify md:pr-20">
                    <div className="animate__animated animate__fadeIn animate__delay-2s">
                        <p className="pb-1 leading-7">
                            ...
                            engineering department of the Ho Chi Minh City
                            University of Technology. I am learning how to be an
                            aspiring front-end developer and looking for a role
                            in an IT company to have the opportunity to work
                            with the latest technologies on diverse and
                            challenging projects.
                        </p>
                        <p className="pb-1 leading-7">
                            With a solid knowledge base, I am always confident
                            in myself. My short term goal is to be a excellent
